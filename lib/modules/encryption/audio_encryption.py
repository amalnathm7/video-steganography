...
# Define the file encryption/decryption functions for audio files
def encrypt_audio(filename, key):
    ...
    print(f'Encrypted audio file saved as {output_filename}')

def decrypt_audio(filename, key):
    ...
    print(f'Decrypted audio file saved as {output_filename}')

# Example usage
key = b'0123456789abcdef' * 2  # 256-bit key
encrypt_audio('assets/secret_files/audios/input.wav', key)
# decrypt_audio('assets/audio_files/song.mp3.enc', key)
